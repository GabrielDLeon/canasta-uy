...
**Open Price UY** is a data analysis and backend development project focused on Uruguayan product pricing from 2016-2025. The project will eventually become a monorepo containing data science pipelines, a Spring Boot backend API, and a frontend (future).
...
5. **Consolidated Data** → **Backend API** (future: Spring Boot)
